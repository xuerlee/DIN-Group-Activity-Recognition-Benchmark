...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        # Dataset
        assert(dataset_name in ['volleyball', 'collective', 'new_new_collective'])
        ...
        if dataset_name=='volleyball':
            ...
            self.data_path='/home/jiqqi/data/new-new-collective/ActivityDataset'  #data path for the collective dataset
            # self.data_path='/home/travail/jiaqi/dataset/new-new-collective/ActivityDataset'  #data path for the collective dataset
